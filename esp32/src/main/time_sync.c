/* NOTE: this is copy pasted from station_example_main.c in esp/esp-idf/examples/wifi/getting_started/station/main! */
...
// #define EXAMPLE_ESP_MAXIMUM_RETRY  EXAMPLE_ESP_MAXIMUM_RETRY
...
void wifi_init_sta(void)
{
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        */
        ...
        esp_sntp_setservername(0, "pool.ntp.org"); // Use a reliable NTP server
        ...
        int current_retry = 0;
        while((sync_status = sntp_get_sync_status() && current_retry < retries_limit) != SNTP_SYNC_STATUS_COMPLETED) {
        ...
        printf("sntp successful, current unix epoch time is: %f\n", seconds_since_epoch);
